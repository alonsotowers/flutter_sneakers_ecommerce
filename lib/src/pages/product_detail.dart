    ...
    return AnimatedBuilder(
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          Image.asset('assets/bad_bunny_3.png')
        ],
      ),
    );
  }
              ...
              children: <Widget>[
                ...
                Container(
                  child: Row(
                    ...
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      TitleText(text: "Adidas X Bad Bunny", fontSize: 25),
                      Column(
  ...
  Widget _sizeWidget(String text, {bool isSelected = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.all(Radius.circular(13)),
        color: isSelected ? Color.fromARGB(255, 23, 7, 23) : Theme.of(context).backgroundColor,
      ),
      child: TitleText(
        text: text,
        fontSize: 16,
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            _colorWidget(Color.fromARGB(199, 72, 46, 20), isSelected: true),
            SizedBox(
              width: 30,
            ),
            _colorWidget(Color.fromARGB(255, 105, 15, 15)),
            SizedBox(
              width: 30,
            ),
